...
func Test_forumRepository_CheckUserByID(t *testing.T) {
	...
	valid, err := repo.CheckUserByID(entity.Thread{UserID: adminID}, adminID)
	if err != nil {
	...
	valid, err = repo.CheckUserByID(entity.Thread{UserID: userID}, userID)
	if err != nil {
