...
import (
	"errors"
	gin2 "github.com/DrusGalkin/forum-client/internal/delivery/gin"
	"net/http"
	"net/http/httptest"
	"strconv"
	"strings"
...
func TestCreateThread(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			mockThread:   entity.Thread{ID: 1, Title: "Test", Content: "Content", UserID: 1},
			expectedCode: http.StatusInternalServerError,
		},
		{
			name:         "unauthorized",
...
func TestCreatePost(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			mockPost:     entity.Post{ID: 1, Content: "Test", ThreadID: 1, UserID: 1, CreateAt: now},
			expectedCode: http.StatusInternalServerError,
		},
		{
			name:         "invalid json",
