...
type ThreadUseCase interface {
	GetUserThreads(userId int) ([]entity.Thread, error)
...
func (f *TUseCase) CheckUserByID(any entity.User, id int) (bool, error) {
	return f.repo.CheckUserByID(any, id)
}

func (f *TUseCase) GetUserThreads(userId int) ([]entity.Thread, error) {
	return f.repo.GetThreadsByUserID(userId)
}

func (f *TUseCase) EditThread(thread entity.Thread, userID int) error {
	return f.repo.EditThread(thread, userID)
}

func (f *TUseCase) GetAllThreads() ([]entity.Thread, error) {
...
func (f *TUseCase) GetThreadByID(id int) (entity.Thread, error) {
...
func (f *TUseCase) CreateThread(thread entity.Thread) (entity.Thread, error) {
